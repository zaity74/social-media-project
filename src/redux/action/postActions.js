...
//     const response = await axios.post("https://social-media-project-backend-xv0z.onrender.com/post", postData, config);
...
export const createPost = (postData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://social-media-project-backend-xv0z.onrender.com/", postData);
...
export const getPosts = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get("https://social-media-project-backend-xv0z.onrender.com/post"); 
...
export const deletePost = (postId) => async (dispatch) => {
  try {
    await axios.delete(`https://social-media-project-backend-xv0z.onrender.com/post/${postId}`);
...
export const getPostCountByUser = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://social-media-project-backend-xv0z.onrender.com/countpost/${userId}`);
...
export const getPostsByUser = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://social-media-project-backend-xv0z.onrender.com/post/${userId}`);
...
export const likePost = (postId, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`https://social-media-project-backend-xv0z.onrender.com/post/like/${postId}`, { userId }, config);
...
export const unlikePost = (postId, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`https://social-media-project-backend-xv0z.onrender.com/post/unlike/${postId}`, { userId }, config);
...
export const addComment = (postId, commentData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`https://social-media-project-backend-xv0z.onrender.com/post/comment`, commentData);
...
export const deleteComment = (commentId, postId) => async (dispatch) => {
  try {
    ...
    await axios.delete(`https://social-media-project-backend-xv0z.onrender.com/delete/comment/${commentId}`);
...
export const getComments = (postId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://social-media-project-backend-xv0z.onrender.com/post/comments/${postId}`);
...
export const searchPosts = (query, user) => async (dispatch) => {
  try {
    ...
    let url = `https://social-media-project-backend-xv0z.onrender.com/search?`;
