...
//     const response = await axios.post("https://socialmediayy.netlify.app/post", postData, config);
...
export const createPost = (postData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post("https://socialmediayy.netlify.app/", postData);
...
export const getPosts = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get("https://socialmediayy.netlify.app/post"); 
...
export const deletePost = (postId) => async (dispatch) => {
  try {
    await axios.delete(`https://socialmediayy.netlify.app/post/${postId}`);
...
export const getPostCountByUser = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://socialmediayy.netlify.app/countpost/${userId}`);
...
export const getPostsByUser = (userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://socialmediayy.netlify.app/post/${userId}`);
...
export const likePost = (postId, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`https://socialmediayy.netlify.app/post/like/${postId}`, { userId }, config);
...
export const unlikePost = (postId, userId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(`https://socialmediayy.netlify.app/post/unlike/${postId}`, { userId }, config);
...
export const addComment = (postId, commentData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(`https://socialmediayy.netlify.app/post/comment`, commentData);
...
export const deleteComment = (commentId, postId) => async (dispatch) => {
  try {
    ...
    await axios.delete(`https://socialmediayy.netlify.app/delete/comment/${commentId}`);
...
export const getComments = (postId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://socialmediayy.netlify.app/post/comments/${postId}`);
...
export const searchPosts = (query, user) => async (dispatch) => {
  try {
    ...
    let url = `https://socialmediayy.netlify.app/search?`;
