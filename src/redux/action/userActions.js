...
export const getUsers = () => async (dispatch) => {
  try {
    ...
    const response = await axios.get("https://socialmedy.netlify.app/user");
...
//         const response = await axios.get("https://socialmedy.netlify.app/user", config);
...
export const updateUser = (userId, userData) => async (dispatch) => {
  try {
    ...
    const response = await axios.put(`https://socialmedy.netlify.app/user/${userId}`, userData, config);
...
export const followUser = (userId, targetUserId) => async (dispatch) => {
  try {
    ...
    const response = await axios.put(
      `https://socialmedy.netlify.app/user/follow/${targetUserId}`,
      { userId },
      config
    );
...
export const unfollowUser = (userId, targetUserId) => async (dispatch) => {
  try {
      ...
      const response = await axios.put(
          `https://socialmedy.netlify.app/user/unfollow/${targetUserId}`,
